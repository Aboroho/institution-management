...
export default function TeacherAttendanceReportPage({ params }: { params: { id: string } }) {
  return (
  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        subtitle={`Section ${str(section?.name)} · Browse historical attendance entries for this course offering.`}
        actions={
          <a
            href={`/teacher/course-offerings/${id}/attendance/take`}
